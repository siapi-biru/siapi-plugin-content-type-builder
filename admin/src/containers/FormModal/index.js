                      ...
                      return (
                        <div className="row" key={index}>
                          {row.map((input, i) => {
                            ...
                            // When extending the yup schema of an existing field (like in https://github.com/siapi/siapi/blob/293ff3b8f9559236609d123a2774e3be05ce8274/packages/siapi-plugin-i18n/admin/src/index.js#L52)
