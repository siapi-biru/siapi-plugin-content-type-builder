  ...
  return {
    ...
    createComponent(infos) {
      ...
      const handler = createSchemaHandler({
        dir: path.join(siapi.dir, 'components', nameToSlug(infos.category)),
      ...
      if (this.components.size === 0) {
        siapi.telemetry.send('didCreateFirstComponent');
      } else {
        siapi.telemetry.send('didCreateComponent');
      }
    ...
    editComponent(infos) {
      ...
      const newDir = path.join(siapi.dir, 'components', newCategory);
